...
#| fig-height: 6
#| out-width: "70%"
#| fig-cap: "Ridge plot showing the size of the standardized regression coefficients for $\\lambda$ values between 0 (OLS) and 100. The vertical dotted line is shown at $\\lambda=22.36$, the value of $\\lambda$ that has the minimum GCV value."
# Ridge trace
ggplot(data = ridge_trace, aes(x = lambda, y = estimate)) +
  geom_line(aes(group = term, color = term)) +
