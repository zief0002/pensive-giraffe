...
and $\lambda__{\mathrm{Max}$ is the largest eigenvalue. The largest eigenvalue will have a condition index of,
...
This value will be larger than 1 since $\frac{\lambda_\mathrm{Max}}{\lambda_\mathrm{Min}}$ will be greater than 1. In general, the largest eigenvalue will have a condition index of 1 and the other condition indices for every other eigenvalue will be larger than one. T
